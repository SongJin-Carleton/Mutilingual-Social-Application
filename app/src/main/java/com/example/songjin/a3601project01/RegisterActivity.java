...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText etAge = (EditText) findViewById(R.id.etRegisterAge);
        final EditText etName = (EditText) findViewById(R.id.etRegisterName);
        ...
        bRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RegisterRequest registerRequest = new RegisterRequest(name, username, age, password, responseLinstener);
